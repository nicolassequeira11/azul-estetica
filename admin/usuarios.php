...
if(isset($_REQUEST['idBorrar'])){
  ...
  <?php
    ...
    <div class="alert alert-danger float-right" role="alert">
      Error al eliminar usuario. <?php echo mysqli_error($con); ?>
    </div>
    <?php
  }
}
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="panel.php?modulo=editarUsuario&id=<?php echo $row['id'] ?>" style="margin-right: 7px"> <i class="fas fa-edit"></i> </a>
