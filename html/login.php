        ...
        <div class="row form-usuario__cont">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <input type="text" name="emailLogin" placeholder="Email *" value="<?php echo $_POST['emailLogin'] ?? '' ?>" class="form-control input-lg">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    <input type="password" name="passLogin" placeholder="Contraseña  *" value="<?php echo $_POST['passLogin'] ?? '' ?>" class="form-control input-lg">
                </div>
            </div>
            <div class="col-sm-12">
                <button class="col-sm-12 form-control-lg form-usuario__boton" name="loginBtn" type="submit">ACCEDER</button>
            </div>

            <div>
                <p class="form-usuario__tit-nc">¿Necesitas registrarte?</p>
                <a class="form-usuario__nc" href="registro.php">Crear Cuenta</a>
            </div>
